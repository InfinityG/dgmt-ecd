...
RUN mkdir -p home
RUN git clone -b dgmt-demo git@github.com:InfinityG/dgmt-ecd.git /home/dgmt-ecd
...
WORKDIR /home/dgmt-ecd

EXPOSE 8000

CMD gulp

# To build: sudo docker build -t infinityg/dgmt-ecd:v1 .
# To run: sudo docker run -it --rm infinityg/dgmt-ecd:v1
